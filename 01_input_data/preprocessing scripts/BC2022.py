...
filtered_columns = ['Gene names', "Position", 'Amino acid',
                    'WT Log(Stimulation/Control)','WT Stimulation vs control q-value',
                    'KO Log(Stim/Control)', 'KO Stimulation vs control q-value', 	
                    'Difference (KO_stimulation / KO_control) vs (WT_stimulation  WT_control)',	'KO_stimulation / KO_control) vs (WT_stimulation  WT_control) q-value']

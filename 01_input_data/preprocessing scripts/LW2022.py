...
file_name = "Phospho (STY)Sites_LW2022.txt"
...
ratio_columns2 = data[[col for col in data.columns if 'ratio' in col]]
...
filtered_columns.extend(list(ratio_columns2.columns))

...
#$ -o logs/raw_data_output.log  # Output log file
#$ -e logs/raw_data_error.log   # Error log file
...
python /data/home/bt23917/PPA/03_matrix_normalisation/raw_data_plot.py  # Update with your script name if different

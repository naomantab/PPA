...
#$ -o logs/normalised_data_output.log  # Output log file
#$ -e logs/normalised_data_error.log   # Error log file
...
python /data/home/bt23917/PPA/03_matrix_normalisation/normalised_data_plot.py  # Update with your script name if different

...
for i in range(0, len(ids), chunk_size):
    ...
    pd.Series(chunk).to_csv(f"C:/Users/tnaom/OneDrive/Desktop/PPA/07_evaluation/omnipath_evaluation/uniprot_ids_chunk_{i//chunk_size + 1}_human.txt", index=False, header=False)

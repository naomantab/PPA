...
lr_df50 = load_data(base_dir, "08_results/xgboost/results_files/xgboost_nested_cv_master_results_file_min50vals.csv")
lr_df100 = load_data(base_dir, "08_results/xgboost/results_files/xgboost_nested_cv_master_results_file_min100vals.csv")
lr_df150 = load_data(base_dir, "08_results/xgboost/results_files/xgboost_nested_cv_master_results_file_min150vals.csv")
lr_df200 = load_data(base_dir, "08_results/xgboost/results_files/xgboost_nested_cv_master_results_file_min200vals.csv")
...
plot_r2(base_dir, lr_df50, lr_df100, lr_df150, lr_df200,  'XGBoost R² across thresholds', '08_results/xgboost/plots/xgboost_r2_across_thresholds.png')